...
const Hero: React.FC = () => {
    ...
    return (
        <section id="home" className="relative h-screen flex items-center justify-center text-center text-white overflow-hidden">
            <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "url('https://picsum.photos/seed/hike-hero/1920/1080')" }}></div>
            <div className="absolute inset-0 bg-brand-dark opacity-70"></div>
            <div className="relative z-10 p-8 flex flex-col items-center">
                <img src="/logo-actionhike.png" alt="Action Hike Logo" className="w-48 md:w-64 mb-4" />
